...
/*   Updated: 2023/10/11 13:30:49 by ael-maar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Form.hpp"

Form::Form(): is_signed(false), grade_sign(10), grade_exec(10) {}
...
Form::Form(Form const &old_obj): is_signed(old_obj.is_signed), grade_sign(old_obj.grade_sign), grade_exec(old_obj.grade_exec) {}
